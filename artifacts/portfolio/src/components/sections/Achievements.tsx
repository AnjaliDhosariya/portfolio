      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-mono font-bold mb-12 flex items-center gap-4">
            <span className="text-secondary text-xl">06.</span> Awards & Certifications
          ...
          >
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={idx} className="flex items-start gap-3 bg-card border border-border p-4 rounded-lg hover:border-primary/50 transition-colors">
          ...
          >
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={idx} className="flex items-center gap-4 bg-card border border-border p-4 rounded-lg hover:border-primary/50 transition-colors">
                  <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary">
                    <Medal size={20} />
                  </div>
                  <div>
                    <h4 className="text-foreground font-bold">{cert.title}</h4>
